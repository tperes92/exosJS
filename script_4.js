...
let bossInSeventies = entrepreneurs.filter(entrepreneur => (entrepreneur.year > 1969 && entrepreneur.year < 1980));
for(let index in bossInSeventies) {
    //console.log(index); 
    console.log(bossInSeventies[index].first + " " + bossInSeventies[index].last);
}
console.log('--------------------- ');

//Sors une array qui contient le prénom et le nom des entrepreneurs ;
console.log('nom et prenom des entrepreneurs en array');
let identify = [];
